---
title: "Facebook Messenger 教育使用例"
date: "2026-07-19"
draft: false
description: "教育現場で Facebook Messenger を使って学習グループとコースコラボレーションを行います。"
aiGenerated: true
...
# Facebook Messenger 教育使用例

**教育現場で Facebook Messenger を使って学習グループとコースコラボレーションを行います。**
